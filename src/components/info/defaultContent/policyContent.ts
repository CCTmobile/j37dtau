...
export const defaultPrivacyContent: ContentSection[] = [
  {
    id: 'introduction',
...
export const defaultTermsContent: ContentSection[] = [
  {
    id: 'introduction',
    title: 'Introduction',
    content: `
...
export const defaultShippingContent: ContentSection[] = [
  {
...
export const defaultReturnsContent: ContentSection[] = [
  {
    id: 'returns-overview',
...
export const defaultHelpContent: ContentSection[] = [
  {
    id: 'help-overview',
    title: 'Help Center',
    content: `
...
export const defaultContactContent: ContentSection[] = [
  {
    id: 'contact-overview',
    title: 'Get in Touch',
    content: `
